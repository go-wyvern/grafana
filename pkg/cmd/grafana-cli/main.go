...
import (
	...
	"github.com/go-wyvern/grafana/pkg/cmd/grafana-cli/commands"
	"github.com/go-wyvern/grafana/pkg/cmd/grafana-cli/logger"
	"github.com/go-wyvern/grafana/pkg/cmd/grafana-cli/services"
	"github.com/go-wyvern/grafana/pkg/cmd/grafana-cli/utils"
)
...
func main() {
	...
	app.Email = "https://github.com/go-wyvern/grafana"
	app.Version = version
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:   "pluginsDir",
