...
You may see an error such as: `package github.com/go-wyvern/grafana: no buildable Go source files`. This is just a warning, and you can proceed with the directions.

## Building the backend
```bash
cd $GOPATH/src/github.com/go-wyvern/grafana
