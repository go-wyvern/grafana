...
- **Alerting**: Adds deduping of alert notifications [#7632](https://github.com/go-wyvern/grafana/pull/7632)
- **Alerting**: Better information about why an alert triggered [#7035](https://github.com/go-wyvern/grafana/issues/7035)
- **Orgs**: Sharing dashboards using Grafana share feature will now redirect to correct org. [#6948](https://github.com/go-wyvern/grafana/issues/6948)
...
We aim to introduce [dashboard groups](https://github.com/go-wyvern/grafana/issues/1611) sometime in the future which will introduce access control and user groups within one org.
