...
Most editor tabs should use the [gf-form css class](https://github.com/go-wyvern/grafana/blob/master/public/sass/components/_gf-form.scss) from Grafana. The example below has one row with a couple of columns and each column is wrapped in a div like this:
